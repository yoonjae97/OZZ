...
<main>
	...
	<div id="searchAll">
		...
		<c:if test="${not empty search['Title'][0]}">
		<div id="recommend">
			<div style="margin-bottom:10px;">추천 미션</div>
			
			<div id="recommendContent" onclick="location.href='/ozz/Mission/MissionView?no=${fn:replace(search['index'][0], '[', '').replace(']', '')}';">
			...
			<div id="recommendContent" onclick="location.href='/ozz/Mission/MissionView?no=${fn:replace(search['index'][1], '[', '').replace(']', '')}';">
			...
			<div id="recommendContent" onclick="location.href='/ozz/Mission/MissionView?no=${fn:replace(search['index'][2], '[', '').replace(']', '')}';">
