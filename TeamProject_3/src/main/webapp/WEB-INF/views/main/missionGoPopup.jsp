...
<main style="width:800px; height: 500px;">
	...
	<div  id="missionGoList">
		...
		<div class="missionContent">
			<li style="font-size: 14px;">${mission_ing.mission_title}</li>
			...
			<input type="hidden" class="missionNo" value="${mission_ing.mission_no}">
			<li><button onclick="closePopupAndNavigate(this);">이어서 진행하기</button></li>
		</div>
		</c:forEach>
	</div>
	</c:otherwise>
...
<script>
function closePopupAndNavigate(button) {
	var missionElement = button.closest('.missionContent').querySelector('.missionNo').value;
    window.opener.location.href = '/ozz/Mission/MissionView?no=' + missionElement;
    window.close();
}
</script>
</main>