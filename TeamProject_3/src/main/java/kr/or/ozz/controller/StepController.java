...
//		dto.setFile_name(imageData);
	...
	// 글내용보기
	@GetMapping("/StepView")
	public ModelAndView StepView(@RequestParam("no") int no, @RequestParam("mission_no") int mission_no, 
			PagingDTO pDTO, HttpServletRequest request) {
		// 레코드선택
		...
		List<TaskDTO> Tasklist = Tservice.Tasklist(no, logid);
