...
def landing_recommand(concern):
    ...
    similar_course_list = []
   # print([similar_course['Index'][4:10].values], 'hi')
    print(33)
    similar_course_list = {"Title" : similar_course['Title'][4:10].values.tolist(), "Content" : similar_course[["Content"]][4:10].values.tolist(), "Tag" : similar_course[['Tag']][4:10].values.tolist(), "Author" : similar_course[['Author']][4:10].values.tolist(), "index" : similar_course[['Index']][4:10].values.tolist()}
